var app = new Vue({
    ...
    methods:{
        ...
        transfer: function(){
            ...
            axios.post(`/api/clients/current/transactions?fromAccountNumber=${this.accountFromNumber}&toAccountNumber=${this.accountToNumber}&amount=${this.amount}&description=${this.description}`,config)
            .then(response => { 
                this.modal.hide();
                this.okmodal.show();
            })
